    ...
    >
      <div style={{ width: '100%', maxWidth: 880, display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, justifyContent: 'center' }}>
          <div
            style={{
              ...
              fontFamily: 'var(--font-amiri), serif', fontWeight: 700, fontSize: 24,
            }}
          >
            ح
          </div>
          <div style={{ lineHeight: 1.25 }}>
            ...
            <Text style={{ fontSize: 11.5, color: c.inkDim }}>
        ...
        <Card styles={{ body: { padding: 18 } }}>
          <Text strong style={{ fontSize: 12.5, color: c.inkMuted }}>
            هەژمارە بەردەستەکان
          </Text>
          <div
            style={{
              ...
              return (
                ...
                >
                  ...
                  <div style={{ marginTop: 9, display: 'flex', gap: 4, flexWrap: 'wrap' }}>
                    ...
                    {disabled && (
                      <span style={{ fontSize: 10, color: c.rust }}>· ناچالاک</span>
                    )}
                  </div>
                </button>
              );
          ...
          <Divider style={{ margin: '18px 0 14px' }}>
            <Text style={{ fontSize: 11, color: c.inkGhost }}>یان</Text>
          </Divider>
        ...
        <Text style={{ fontSize: 11, color: c.inkGhost, textAlign: 'center' }}>
