...
export default function SetupNotice({ error }: { error?: string }) {
  return (
    <div style={{ padding: 28, overflowY: 'auto' }}>
      ...
      >
        <h1 style={{ margin: '0 0 6px', fontSize: 17, fontWeight: 700, color: c.ink }}>
          داتابەیسی نموونە ئامادە نییە
        </h1>
        <p style={{ margin: '0 0 18px', fontSize: 14.5, lineHeight: 1.9, color: c.inkMuted }}>
        ...
        <pre
          ...
          style={{
            ...
            border: `1px solid ${c.line}`, fontSize: 14, lineHeight: 1.9,
        ...
        {error && (
          <p
            ...
            style={{
              ...
              background: c.rustSoft, color: c.rust, fontSize: 13.5, lineHeight: 1.7,
